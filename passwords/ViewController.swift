...
//  passwords
//
//  Created by LI,JYUN-SIAN on 17/6/23.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet var passwordsImageViews: [UIImageView]!
    ...
    func imageChange() {
        ...
        case 1:
            for i in 0...3 {
                passwordsImageViews[i].isHighlighted = true
                if i > 0 {
                    passwordsImageViews[i].isHighlighted = false
                }
            }
        case 2:
            for i in 0...3 {
